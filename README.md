# WD Builders Customer Mobile App

## 🚀 Overview

This Flutter mobile application is the customer-facing app for WD Builders, integrated with the wd-cust-api backend for authentication and data management.

**Status**: ✅ API Integration Complete

## 🔗 API Integration

This app is now fully integrated with the **wd-cust-api** Spring Boot backend:
...
2. **Configure API URL**: Edit `lib/config/api_config.dart`
   ```dart
   static const String baseUrl = 'http://10.0.2.2:8081';  // Android
   ```
...
- **[Integration Summary](INTEGRATION_SUMMARY.md)** - Overview of API integration
- **[Integration Guide](API_INTEGRATION_GUIDE.md)** - Comprehensive setup guide
- **[Testing Instructions](API_TESTING_INSTRUCTIONS.md)** - Step-by-step testing
- **[Quick Reference](API_QUICK_REFERENCE.md)** - Code examples & shortcuts
